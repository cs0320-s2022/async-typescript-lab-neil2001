...
const sunVal : HTMLElement = document.getElementById("sun") as HTMLElement
const moonVal : HTMLElement = document.getElementById("moon") as HTMLElement
const risingVal : HTMLElement = document.getElementById("rising") as HTMLElement

// Here, when the value of sun is changed, we will call the method postAndUpdate.
// TODO: Do the same for moon and rising
sunVal.addEventListener("change", postAndUpdate)
moonVal.addEventListener("change", postAndUpdate)
risingVal.addEventListener("change", postAndUpdate)
...
document.addEventListener("keyup", async (event : KeyboardEvent) => {
    if (event.key == 'r') {
        await updateValues("Libra", "Capricorn", "Scorpio")
        postAndUpdate();
    }
});
