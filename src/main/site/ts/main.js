...
const sunVal = document.getElementById("sun");
const moonVal = document.getElementById("moon");
const risingVal = document.getElementById("rising");
...
document.addEventListener("keyup", (event) => __awaiter(void 0, void 0, void 0, function* () {
    if (event.key == 'r') {
        yield updateValues("Libra", "Capricorn", "Scorpio");
        postAndUpdate();
    }
}));
